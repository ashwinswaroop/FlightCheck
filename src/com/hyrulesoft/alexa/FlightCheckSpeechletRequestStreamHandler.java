 ...
 * Lambda console to "spacegeek.SpaceGeekSpeechletRequestStreamHandler" For this
 * to work, you'll also need to build this project using the
 * {@code lambda-compile} Ant task and upload the resulting zip file to power
 * your function.
 */
public final class FlightCheckSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
